...
public class DocumentClientDemo {
    public static void main(String[] args) {
        String url = "http://dev03.hdpi.com.cn:8000/webservices/SOAProvider/plsql/ws_client_return_pkg/?wsdl";
        ...
        try {
            ...
            while (resultIterator.hasNext()) {
                ...
                if (element != null && "P_COUNT".equals(element.getLocalName())) {
                    System.out.println("返回值==" + element.getText());
                }
            }
        } catch (AxisFault e) {
            e.printStackTrace();
